...
final class Version20260524123000 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE taha DROP first_name, DROP last_name, DROP title, DROP address, DROP interests, DROP meal_preference, DROP newsletter_consent, DROP data_protection_consent');
    }
}
