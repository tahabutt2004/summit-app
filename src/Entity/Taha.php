...
use App\Repository\TahaRepository;
...
#[ORM\Entity(repositoryClass: TahaRepository::class)]
#[ORM\Table(name: 'taha')]
#[ORM\UniqueConstraint(name: 'UNIQ_IDENTIFIER_EMAIL', fields: ['email'])]
#[UniqueEntity(fields: ['email'], message: 'There is already an account with this email')]
class Taha implements UserInterface, PasswordAuthenticatedUserInterface
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    public function isDataProtectionConsent(): bool
    {
        return $this->dataProtectionConsent;
    }

    public function setDataProtectionConsent(bool $dataProtectionConsent): static
    {
